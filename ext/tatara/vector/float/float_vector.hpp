...
FloatVector& FloatVector::intersection(const FloatVector* other) {
...
static VALUE wrap_float_vector_convert_array(VALUE self) {
...
static VALUE wrap_float_vector_intersection(VALUE self, VALUE other) {
